...
\textit{\textbf{N.B.}: The notion of a ``room'' in Matrix is already an abstract representation of a physical space in which users interact, but is rather transparent.
...
In order to promote easy navigation of the vast numbers of patient rooms that will be created, we employ the built-in Group function of the Matrix protocol. This allows patients to be organized into groups associated with the facilities that care for and service them.
