...
%
  ...
  \textit{\textbf{N.B.: It seems nontrivial that only one user type is expounded upon in this section.}}%
...
In order to promote easy navigation of the vast numbers of patient rooms that will be created, we employ the Group function that is built into the Matrix protocol. This allows patients to be organized into groups associated with the facilities that care for and service them. The user who is responsible for managing a facility and its patient can create patient 
