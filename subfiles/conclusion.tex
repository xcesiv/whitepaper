...
The success of DuraChain and the future we envision require that \textsc{dme} providers choose our environment over our competitors. The ensure that we position ourselves strongly, we will be implementing a test environment that invited \textsc{dme} providers will gain early access to.
...
We believe that success in this goal hinges on placing as much power as possible into the hands of all healthcare providers everywhere. As we've discussed in this paper, DuraChain is well-positioned to catalyze the necessary shift in patient data.%
